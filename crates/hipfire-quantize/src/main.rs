...
///   - `quantize_mg4g256` produces files with `QuantType::MG4G256 = 30`
...
enum QuantType {
    ...
    MG4G256 = 30,  // Magnum-Gemma 4-bit: same MQ4 binary (136 B/group), engine
                   ...
                   // ID reassigned 19→30 during 2026-05-18 rebase (19 taken by
                   // MQ2G256Lloyd on master).
}
...
fn main() {
    ...
    // Engine treats `MG4G256 = 30` as MQ4G256 at dequant time — kernel
